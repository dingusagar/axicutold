...
public class RangeSelector2 {
    ...
    public RangeSelector2(Context context , RecyclerViewRefresher refresher, int highestWOnum) {
        this.context = context;
        this.refresher = refresher;
        this.highestWOnum=highestWOnum;
        selectedItems=new boolean[highestWOnum+1];
        setupDialog();
    }
